...
import time
import random
from helpers import append_data_to_csv, load_data_from_csv, is_in_game
                ...
                # pitch has not started
                    ...
                    if dolphin.read_int16(current_pitch_frame) == 0 and dolphin.read_int16(pitch_duration) != -1:
                        if active_pitch:
                            ...
                            if bat_id and bat_hand and pitch_id and pitch_hand and pitch_pos_x and p_type:
                                append_data_to_csv(
